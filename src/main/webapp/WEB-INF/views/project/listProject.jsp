...
<table class="table is bordered is-striped ui-narrow is-hoverable is-fullwidth" style="background-color: lightsteelblue">
    ...
    <c:forEach items="${project}" var="project" varStatus="stat">
        <tr>
            ...
            <td><a href="${pageContext.request.contextPath}/material/list">Lista materiałów</a></td>
            <td><a href="${pageContext.request.contextPath}/project/delete?id=${project.id}">Usuń</a></td>
        </tr>
    </c:forEach>
</table>
